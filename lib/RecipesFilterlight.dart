...
class RecipesFilterlight extends StatelessWidget {
  RecipesFilterlight({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(30.0, 812.0, 315.0, 523.0),
                    ...
                    child:
                      ...
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 317.0, 315.0, 206.0),
                          size: Size(315.0, 523.0),
                          pinLeft: true,
                          pinRight: true,
                          pinBottom: true,
                          fixedHeight: true,
                          ...
                          child:
                            ...
                            child: Stack(
                              children: <Widget>[
                                Pinned.fromSize(
                                  bounds:
                                      Rect.fromLTWH(0.0, 202.0, 315.0, 100.0),
                                ...
                                Pinned.fromSize(
                                  bounds:
                                      Rect.fromLTWH(29.0, 262.0, 257.0, 14.0),
                                  size: Size(315.0, 302.0),
                                  pinLeft: true,
                                  pinRight: true,
                                  pinBottom: true,
                                ...
                                Pinned.fromSize(
                                  bounds:
                                      Rect.fromLTWH(29.0, 240.0, 132.0, 16.0),
                                  size: Size(315.0, 302.0),
                                  pinLeft: true,
                                  fixedWidth: true,
                                  fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    ...
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'icon-search' (component)
                        iconsearch(),
                  ),
                  Pinned.fromSize(
...
const String _svg_wfdz2s =
    '<svg viewBox="0.0 741.0 375.0 71.0" ><path transform="translate(0.0, 741.0)" d="M 375 0 L 375 71 L 0 71 L 375 0 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
