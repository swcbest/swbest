            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(130.0, 656.0, 116.0, 14.0),
                    size: Size(375.0, 707.0),
                    pinBottom: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(30.0, 547.0, 315.0, 60.0),
                    size: Size(375.0, 707.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(129.0, 448.0, 118.0, 16.0),
                    size: Size(375.0, 707.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(30.0, 359.0, 315.0, 60.0),
                    size: Size(375.0, 707.0),
                    pinLeft: true,
                    pinRight: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(51.0, 377.0, 20.0, 22.2),
                    size: Size(375.0, 707.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Iconpadlock' (component)
                        Iconpadlock(),
                  ),
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(30.0, 284.0, 315.0, 60.0),
                    size: Size(375.0, 707.0),
                    pinLeft: true,
                    pinRight: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(51.0, 307.0, 20.0, 15.0),
                    size: Size(375.0, 707.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Iconmail' (component)
                        Iconmail(),
                  ),
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(154.0, 149.0, 68.0, 24.0),
                    size: Size(375.0, 707.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
