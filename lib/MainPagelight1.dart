...
class MainPagelight1 extends StatelessWidget {
          ...
          GestureDetector(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 375.5, 812.0),
                    ...
                    child:
                      ...
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(-180.5, 181.5, 737.0, 375.0),
                          size: Size(375.5, 812.0),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
